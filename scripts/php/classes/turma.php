...
class Turma extends Model
{
    ...
    public function listarTurmas()
    {
        $sql = "SELECT
                ...
                DATE_FORMAT(hora_inicio, '%H:%i'),
                '-',
                DATE_FORMAT(hora_fim, '%H:%i')) AS hora_formatada
                FROM turmas
                ORDER BY 
    ...
    // Método NOVO para cadastro rápido
    /* TODO: Assim como na classe aluno, a permanecia desses metodos devem ser reavaliadas posteriormente. */
