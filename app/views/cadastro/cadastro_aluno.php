...
<!-- ============================================== 
    Realizar a centralização da lógica e a modularização
    de partes lógicas do código com services e functions
-->
    ...
    <main class="section">
        <div class="container">
            ...
            <div class="box">
                ...
                <form method="POST" action="<?= url('/cadastro/aluno/post')?>">
                    <div class="field">
